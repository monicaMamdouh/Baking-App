 ...
 */
public class StepsDetailFragment extends Fragment  implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       if(mStepIndex==null) {
            mStepIndex = (Steps) bundle.getSerializable("StepObject");
        }

        mShortDescriptionTextView.setText(mStepIndex.getShortDescription());
        mDescriptionTextView.setText(mStepIndex.getDescription());

        if(!mStepIndex.getThumbURL().equals(""))
            Glide.with(getContext()).load(mStepIndex.getThumbURL()).into(mPosterImageView);
    ...
    public void setStepIndex(Steps steps) {
        mStepIndex=steps;
    }
